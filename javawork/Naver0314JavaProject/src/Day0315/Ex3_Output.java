...
public class Ex3_Output {
	...
	public static void main(String[] args) {
		...
		System.out.println("================");
		//printf 를 이용해서 출력해보자(JDK 5 부터 가능)
		//변환기호를 이용해서 출력한다
		...
		System.out.printf("평균:%3.1f점\n",avg);//%3.1 : 전체 자리수 3자리, 소수점 이하 자리수 1자리
		System.out.printf("평균:%10.2f점\n",avg);//%10.2 : 전체자리수 10자리(남을 경우 공백처리), 소수점 이하 자리수 2자리
		System.out.printf("평균:%-10.2f점\n",avg);//%-10.2 : 전체자리수 10자리(왼쪽으로 출력, 남을 경우 공백처리), 소수점 이하 자리수 2자리
	}
