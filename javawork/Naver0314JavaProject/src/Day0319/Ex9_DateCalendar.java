...
public class Ex9_DateCalendar {
	...
	public static void main(String[] args) {
		...
		//Date 클래스를 이용해서 년,월,일,시,분,초 얻기(JDK 1.1 이후 Deprecate되었고 Calendar를 권장하나 여전히 많이 사용중)
		Date date=new Date(); //디폴트로 생성시 현재 날짜와 시간을 얻는다
		int year=date.getYear()+1900;//년도는 1900이 빠진 값으로 반환됨.
		int month=date.getMonth()+1;//월은 0~11이 반환됨.
		int day=date.getDate();
		int week=date.getDay();//요일(0:일, 1:월, 2:화, 3:수. ...6:토)
		...
		year=cal.get(Calendar.YEAR);//2024 그대로 반환
